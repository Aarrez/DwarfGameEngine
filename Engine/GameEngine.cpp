...
namespace Engine {
    ...
    void GameEngine::Render() {
        ...
        glBindFramebuffer(GL_FRAMEBUFFER, shadow_map.depthMapFBO);
            ...
            TempRenderScene(*simpleDepthShader);
